...
func (p *HbaseClient) GetRegionInfo(ctx context.Context, row Text) (r *TRegionInfo, err error) {
	...
	if err = p.Client_().Call(ctx, "getRegionInfo", &_args89, &_result90); err != nil {
		return
	}
	switch {
...
func (p *HbaseClient) Append(ctx context.Context, append *TAppend) (r []*TCell, err error) {
	...
	if err = p.Client_().Call(ctx, "append", &_args91, &_result92); err != nil {
		return
	}
	switch {
...
func (p *HbaseClient) CheckAndPut(ctx context.Context, tableName Text, row Text, column Text, value Text, mput *Mutation, attributes map[string]Text) (r bool, err error) {
	...
	if err = p.Client_().Call(ctx, "checkAndPut", &_args93, &_result94); err != nil {
		return
	}
	switch {
...
//
// @return the type of this thrift server
func (p *HbaseClient) GetThriftServerType(ctx context.Context) (r TThriftServerType, err error) {
	var _args95 HbaseGetThriftServerTypeArgs
	var _result96 HbaseGetThriftServerTypeResult
	if err = p.Client_().Call(ctx, "getThriftServerType", &_args95, &_result96); err != nil {
		return
	}
...
// Returns the cluster ID for this cluster.
func (p *HbaseClient) GetClusterId(ctx context.Context) (r string, err error) {
	var _args97 HbaseGetClusterIdArgs
	var _result98 HbaseGetClusterIdResult
	if err = p.Client_().Call(ctx, "getClusterId", &_args97, &_result98); err != nil {
		return
	}
...
func NewHbaseProcessor(handler Hbase) *HbaseProcessor {
	...
	self99 := &HbaseProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self99.processorMap["enableTable"] = &hbaseProcessorEnableTable{handler: handler}
	self99.processorMap["disableTable"] = &hbaseProcessorDisableTable{handler: handler}
	self99.processorMap["isTableEnabled"] = &hbaseProcessorIsTableEnabled{handler: handler}
	self99.processorMap["compact"] = &hbaseProcessorCompact{handler: handler}
	self99.processorMap["majorCompact"] = &hbaseProcessorMajorCompact{handler: handler}
	self99.processorMap["getTableNames"] = &hbaseProcessorGetTableNames{handler: handler}
	self99.processorMap["getColumnDescriptors"] = &hbaseProcessorGetColumnDescriptors{handler: handler}
	self99.processorMap["getTableRegions"] = &hbaseProcessorGetTableRegions{handler: handler}
	self99.processorMap["createTable"] = &hbaseProcessorCreateTable{handler: handler}
	self99.processorMap["deleteTable"] = &hbaseProcessorDeleteTable{handler: handler}
	self99.processorMap["get"] = &hbaseProcessorGet{handler: handler}
	self99.processorMap["getVer"] = &hbaseProcessorGetVer{handler: handler}
	self99.processorMap["getVerTs"] = &hbaseProcessorGetVerTs{handler: handler}
	self99.processorMap["getRow"] = &hbaseProcessorGetRow{handler: handler}
	self99.processorMap["getRowWithColumns"] = &hbaseProcessorGetRowWithColumns{handler: handler}
	self99.processorMap["getRowTs"] = &hbaseProcessorGetRowTs{handler: handler}
	self99.processorMap["getRowWithColumnsTs"] = &hbaseProcessorGetRowWithColumnsTs{handler: handler}
	self99.processorMap["getRows"] = &hbaseProcessorGetRows{handler: handler}
	self99.processorMap["getRowsWithColumns"] = &hbaseProcessorGetRowsWithColumns{handler: handler}
	self99.processorMap["getRowsTs"] = &hbaseProcessorGetRowsTs{handler: handler}
	self99.processorMap["getRowsWithColumnsTs"] = &hbaseProcessorGetRowsWithColumnsTs{handler: handler}
	self99.processorMap["mutateRow"] = &hbaseProcessorMutateRow{handler: handler}
	self99.processorMap["mutateRowTs"] = &hbaseProcessorMutateRowTs{handler: handler}
	self99.processorMap["mutateRows"] = &hbaseProcessorMutateRows{handler: handler}
	self99.processorMap["mutateRowsTs"] = &hbaseProcessorMutateRowsTs{handler: handler}
	self99.processorMap["atomicIncrement"] = &hbaseProcessorAtomicIncrement{handler: handler}
	self99.processorMap["deleteAll"] = &hbaseProcessorDeleteAll{handler: handler}
	self99.processorMap["deleteAllTs"] = &hbaseProcessorDeleteAllTs{handler: handler}
	self99.processorMap["deleteAllRow"] = &hbaseProcessorDeleteAllRow{handler: handler}
	self99.processorMap["increment"] = &hbaseProcessorIncrement{handler: handler}
	self99.processorMap["incrementRows"] = &hbaseProcessorIncrementRows{handler: handler}
	self99.processorMap["deleteAllRowTs"] = &hbaseProcessorDeleteAllRowTs{handler: handler}
	self99.processorMap["scannerOpenWithScan"] = &hbaseProcessorScannerOpenWithScan{handler: handler}
	self99.processorMap["scannerOpen"] = &hbaseProcessorScannerOpen{handler: handler}
	self99.processorMap["scannerOpenWithStop"] = &hbaseProcessorScannerOpenWithStop{handler: handler}
	self99.processorMap["scannerOpenWithPrefix"] = &hbaseProcessorScannerOpenWithPrefix{handler: handler}
	self99.processorMap["scannerOpenTs"] = &hbaseProcessorScannerOpenTs{handler: handler}
	self99.processorMap["scannerOpenWithStopTs"] = &hbaseProcessorScannerOpenWithStopTs{handler: handler}
	self99.processorMap["scannerGet"] = &hbaseProcessorScannerGet{handler: handler}
	self99.processorMap["scannerGetList"] = &hbaseProcessorScannerGetList{handler: handler}
	self99.processorMap["scannerClose"] = &hbaseProcessorScannerClose{handler: handler}
	self99.processorMap["getRegionInfo"] = &hbaseProcessorGetRegionInfo{handler: handler}
	self99.processorMap["append"] = &hbaseProcessorAppend{handler: handler}
	self99.processorMap["checkAndPut"] = &hbaseProcessorCheckAndPut{handler: handler}
	self99.processorMap["getThriftServerType"] = &hbaseProcessorGetThriftServerType{handler: handler}
	self99.processorMap["getClusterId"] = &hbaseProcessorGetClusterId{handler: handler}
	return self99
}
...
type hbaseProcessorGetThriftServerType struct {
	handler Hbase
}

func (p *hbaseProcessorGetThriftServerType) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := HbaseGetThriftServerTypeArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	result := HbaseGetThriftServerTypeResult{}
...
type hbaseProcessorGetClusterId struct {
	handler Hbase
}

func (p *hbaseProcessorGetClusterId) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := HbaseGetClusterIdArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	result := HbaseGetClusterIdResult{}
	var retval string
	var err2 error
...
func (p *HbaseCreateTableArgs) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.ColumnFamilies = append(p.ColumnFamilies, _elem105)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseGetRowWithColumnsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem118)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseGetRowWithColumnsTsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem125)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseGetRowsWithColumnsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem134)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseGetRowsWithColumnsTsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem143)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseMutateRowArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Mutations = append(p.Mutations, _elem147)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseMutateRowTsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Mutations = append(p.Mutations, _elem150)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseIncrementRowsArgs) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Increments = append(p.Increments, _elem165)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseScannerOpenArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem170)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseScannerOpenWithStopArgs) ReadField4(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem173)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseScannerOpenWithPrefixArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem176)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseScannerOpenTsArgs) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem179)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *HbaseScannerOpenWithStopTsArgs) ReadField4(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Columns = append(p.Columns, _elem182)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type HbaseGetThriftServerTypeArgs struct {
}

func NewHbaseGetThriftServerTypeArgs() *HbaseGetThriftServerTypeArgs {
	return &HbaseGetThriftServerTypeArgs{}
}

func (p *HbaseGetThriftServerTypeArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *HbaseGetThriftServerTypeArgs) Write(oprot thrift.TProtocol) error {
...
func (p *HbaseGetThriftServerTypeArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HbaseGetThriftServerTypeArgs(%+v)", *p)
}

// Attributes:
//  - Success
type HbaseGetThriftServerTypeResult struct {
	Success *TThriftServerType `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewHbaseGetThriftServerTypeResult() *HbaseGetThriftServerTypeResult {
	return &HbaseGetThriftServerTypeResult{}
}

var HbaseGetThriftServerTypeResult_Success_DEFAULT TThriftServerType

func (p *HbaseGetThriftServerTypeResult) GetSuccess() TThriftServerType {
	if !p.IsSetSuccess() {
		return HbaseGetThriftServerTypeResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *HbaseGetThriftServerTypeResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *HbaseGetThriftServerTypeResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *HbaseGetThriftServerTypeResult) ReadField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return thrift.PrependError("error reading field 0: ", err)
	} else {
...
func (p *HbaseGetThriftServerTypeResult) Write(oprot thrift.TProtocol) error {
...
func (p *HbaseGetThriftServerTypeResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *HbaseGetThriftServerTypeResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HbaseGetThriftServerTypeResult(%+v)", *p)
}

type HbaseGetClusterIdArgs struct {
}

func NewHbaseGetClusterIdArgs() *HbaseGetClusterIdArgs {
	return &HbaseGetClusterIdArgs{}
}

func (p *HbaseGetClusterIdArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *HbaseGetClusterIdArgs) Write(oprot thrift.TProtocol) error {
...
func (p *HbaseGetClusterIdArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HbaseGetClusterIdArgs(%+v)", *p)
}

// Attributes:
//  - Success
type HbaseGetClusterIdResult struct {
	Success *string `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewHbaseGetClusterIdResult() *HbaseGetClusterIdResult {
	return &HbaseGetClusterIdResult{}
}

var HbaseGetClusterIdResult_Success_DEFAULT string

func (p *HbaseGetClusterIdResult) GetSuccess() string {
	if !p.IsSetSuccess() {
		return HbaseGetClusterIdResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *HbaseGetClusterIdResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *HbaseGetClusterIdResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *HbaseGetClusterIdResult) ReadField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 0: ", err)
	} else {
		p.Success = &v
...
func (p *HbaseGetClusterIdResult) Write(oprot thrift.TProtocol) error {
...
func (p *HbaseGetClusterIdResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *HbaseGetClusterIdResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HbaseGetClusterIdResult(%+v)", *p)
}
